...
#define SAVENAME_RE_BG  R"re(exult.*bg\.sav)re"
#define SAVENAME_RE_SI  R"re(exult.*si\.sav)re"
#define SAVENAME_RE_DEV R"re(exult.*dev\.sav)re"
...
#define MODCFG_REGEX    R"re(.*\.cfg)re"
